...
| AWS | <ul> <li>Zone géographique AWS </li> <li> Compartiment AWS <li> Clé d’accès AWS </li><li> Secret d’accès AWS </li></ul> |
...
## Vidéo : importer des ressources en bloc à l’aide d’Assets Essentials
