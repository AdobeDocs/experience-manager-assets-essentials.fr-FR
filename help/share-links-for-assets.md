...
1. Cliquez sur **[!UICONTROL Générer le lien]**.

1. Cliquez sur **[!UICONTROL Copier le lien]** pour copier le lien. Vous pouvez également copier le lien à partir du champ **[!UICONTROL Partager le lien]**.
